...
import { AppBar, Box, Chip, IconButton, InputBase, Stack, Toolbar, useTheme } from "@mui/material";
      ...
      <Toolbar>
        <Box sx={{ flexGrow: 1 }}>
          <Box
            display="flex"
            alignItems="center"
            sx={{ backgroundColor: colors.primary[400], borderRadius: "3px", maxWidth: "15vw" }}
            component="form"
            noValidate
            autoComplete="off"
            onSubmit={(e) => {
              e.preventDefault(); // Prevent default form submission
              const searchString = (e.target as HTMLFormElement).elements.namedItem("searchString") as HTMLInputElement;
              onSearchInputChange(searchString?.value || "");
            }}
          >
            <InputBase sx={{ ml: 1, width: "100%" }} name="searchString" onChange={handleSearchBarChange} placeholder="Search" />
...
// import { AppBar, Box, Chip, IconButton, InputBase, Stack, useTheme } from "@mui/material";
// import { ColorModeContext, tokens } from "../themes.tsx";
// import { DarkModeOutlined, LightModeOutlined, Search } from "@mui/icons-material/";
// import { doSignOut } from "../hooks/authUtil.tsx";
// import { useNavigate } from "react-router-dom";
